...
/*
 * These classes are copyright Kevin Steppe (see code for terms) and may
 * be used freely within the Log4J framework.  Use outside of Log4J or other
 * Apache projects may require written permission from Kevin Steppe, see
 * license terms in those classes.
 */
//import com.pterodactyls.WildCardFileFilter;
//import com.pterodactyls.StringTokenizer;
...
public class CompositeRollingAppender extends org.apache.log4j.FileAppender {
  ...
  */
  ...
  protected void existingInit() {
	...
	LogLog.debug(sdf.format(last) + " vs. " + sdf.format(now));
