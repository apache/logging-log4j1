...
public interface Connection {
     ...
     * @return a callable to complete the append, or null if the action was completed.
     */
    Callable<?> append(LogEvent record) throws LoggingException;

    /**
     *  Closes the destination.
     * @return a callable to complete the close, or null if the close was completed.
     */
